theme: /ticketExchange
    ...
    state: wannaChangeTicketParameters
        ...
        q!: * {$changeInfAll [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * на (другой/другую/другое/другие) ($flight/~вылет/~отлет/~отлёт/~рейс/~время/~дата/~число) *
        q!: * на (другой/другую/другое/другие) ($flight/~вылет/~отлет/~отлёт/~рейс/~время/~дата/~число) * {$changeInfAll [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        go!: /ticketExchange/wannaExchangeTicket
    ...
    state: changeTicketFromDateToDate
        ...
        q!: * {$changeInfAll [$NumberOneDigit/$my2/$ruSvoi] [$ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс]} * $iataAndRailway::fromCode * $iataAndRailway::destCode * с ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) на ($dateDig::dateDig2/$dateLetters::dateLetters2) [$markQuestion] $weight<+1>
        go!: /ticketExchange/wannaExchangeTicket
    ...
    state: wannaChangeTicketFullInfo
        ...
        # 4 города
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] *
        q!: * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        ...
        q!: * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] *
        q!: * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::destCode $iataAndRailway::fromCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        # 3 города
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] *
        q!: * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] *
        q!: * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] *
        q!: * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * [$roundTrip] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode *
        q!: [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * [($dateDig::dateDig2/$dateLetters::dateLetters2)] * $iataAndRailway::fromCode $iataAndRailway::destCode $iataAndRailway::fromCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        # 2 города
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * $iataAndRailway::destCode * [$roundTrip] *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * $iataAndRailway::destCode * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] * $iataAndRailway::fromCode * $iataAndRailway::destCode *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] * $iataAndRailway::fromCode * $iataAndRailway::destCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * $iataAndRailway::destCode *
        q!: * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * $iataAndRailway::destCode *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * $iataAndRailway::destCode *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode * $iataAndRailway::destCode *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::destCode *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::fromCode * $iataAndRailway::destCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *

        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] *
        q!: * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) *
        q!: * [$roundTrip] * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode * [$roundTrip] *
        q!: * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode *
        q!: * [$roundTrip] * $iataAndRailway::fromCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] *
        q!: * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) *
        q!: * [$roundTrip] * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode * [$roundTrip] *
        q!: * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode *
        q!: * [$roundTrip] * ($dateDig::dateDig1/$dateLetters::dateLetters1/$numberDate) * $iataAndRailway::fromCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * $iataAndRailway::destCode * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        ...
        q!: * [$roundTrip] * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * $iataAndRailway::fromCode * [$roundTrip] * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * $iataAndRailway::fromCode * $iataAndRailway::destCode * [$roundTrip] * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * [$roundTrip] * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * $iataAndRailway::fromCode * $iataAndRailway::destCode * ($dateDig::dateDig2/$dateLetters::dateLetters2) * {$changeInfAll [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * [$roundTrip] *
    ...
    state: wannaChangeTicketFromDest
        ...
        q!: * $iataAndRailway::fromCode [$to] [$cityPreName] $iataAndRailway::destCode * {($changeInfAll/$replaceNoun) [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} *
        q!: * {($changeInfAll/$replaceNoun) [~время/~дата/~число] [$NumberOneDigit/$my2/$ruSvoi] ($ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс)} * $iataAndRailway::fromCode [$to] [$cityPreName] $iataAndRailway::destCode *
    ...
    state: howLongWillItTakeToExchangeMyTicket
         ...
         q!: * $howLong * {($changeInfAll/$exchangeAllExceptPast/$replaceNoun) [$NumberOneDigit/$my2/$ruSvoi] [$ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс]} *
         q!: * {($changeInfAll/$exchangeAllExceptPast/$replaceNoun) [$NumberOneDigit/$my2/$ruSvoi] [$ticket/$airplaneTicket/$flight/~вылет/~отлет/~отлёт/~рейс]} * $howLong *
         go!: /documentsFaqAns/tellMeYoutOrderNumb
