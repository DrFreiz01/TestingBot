theme: /baggageToExistingTicket
    ...
    state: addBaggageToOrder
        ...
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * $baggageAll *
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $baggageAll * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $baggageAll *
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * $baggageAll * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * $baggageAll * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * $baggageAll * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        q!: * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * $baggageAll *
        q!: * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * $baggageAll * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * $baggageAll *
        q!: * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * $baggageAll * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) *
        q!: * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $baggageAll * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $baggageAll * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) *
        q!: * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $baggageAll *
        q!: * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * $baggageAll * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        q!: * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * $baggageAll *
        q!: * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $baggageAll * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) *
        q!: * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * $baggageAll * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        q!: * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * $baggageAll * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) *
        q!: * $baggageAll * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * $baggageAll * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        q!: * $baggageAll * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * $baggageAll * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) *
        q!: * $baggageAll * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        q!: * $baggageAll * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * (в/во/к/ко) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) *
    ...
    state: roundtripTicketsHowManyBaggage
        ...
        q!: * ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $roundTrip * {(должен/должна/должны/$need2) * (один/одного/одново/одну/одних/1) $baggageAll ($buyAllExceptPast/$issueAllExceptPast/$bookInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*)} *
        q!: * $roundTrip * ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * (должен/должна/должны/$need2) * {(один/одного/одново/одну/одних/1) $baggageAll ($buyAllExceptPast/$issueAllExceptPast/$bookInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*)} *
        q!: * (должен/должна/должны/$need2) * {(один/одного/одново/одну/одних/1) $baggageAll ($buyAllExceptPast/$issueAllExceptPast/$bookInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*)} * ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) * $roundTrip *
        q!: * (должен/должна/должны/$need2) * {(один/одного/одново/одну/одних/1) $baggageAll ($buyAllExceptPast/$issueAllExceptPast/$bookInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*)} * $roundTrip * ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) *
        script:
    ...
    state: iHaveTicketsHowToBuyBaggage
        ...
        q!: * {(у $meGenAcc) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * {$baggageAll ($buyAllExceptPast/$issueAllExceptPast/$bookInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*)} *
        # 4EX: Добрый день,подскажите пожалуйста ,можно поменять билет с багажом , т.к.у меня билет без
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * {($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс) (с $baggageAll)} * {(у $meGenAcc) [$ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс]} без [него/его/ево/$baggageAll] [$markQuestion]
        go!: /baggageToExistingTicket/boughtTicketsHowToBuyBaggage
    ...
    state: byAccidentBoughtTicketsWithNoBaggage
        ...
        q!: * (случайн*/неспециальн*/неспецальн*/$ne (специальн*/спецальн*)) * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * $without $baggageAll
        q!: * (случайн*/неспециальн*/неспецальн*/$ne (специальн*/спецальн*)) * $without $baggageAll * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)}
        q!: * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * (случайн*/неспециальн*/неспецальн*/$ne (специальн*/спецальн*)) * $without $baggageAll
        q!: * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * $without $baggageAll * (случайн*/неспециальн*/неспецальн*/$ne (специальн*/спецальн*))
        q!: * $without $baggageAll * (случайн*/неспециальн*/неспецальн*/$ne (специальн*/спецальн*)) * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)}
        q!: * $without $baggageAll * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * (случайн*/неспециальн*/неспецальн*/$ne (специальн*/спецальн*))
        go!: /baggageToExistingTicket/boughtTicketsHowToBuyBaggage
    ...
    state: boughtTicketsHowToBuyBaggage
        ...
        q!: * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * {($issueVerbInf/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$take) ([за] $baggageAll)} *
        q!: * {($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*) [мест*] $baggageAll} * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} *
        ...
        q!: * ($issueVerbInf/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$take) * {(куплен*/оформлен*/заказан*/оплачен*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * $baggageAll *
        q!: * ($issueVerbInf/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$take) * $baggageAll * {(куплен*/оформлен*/заказан*/оплачен*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} *
        # 4EX: Добрый день! Купили билеты без багажа. Хочу дозаказать. Как это сделать?
        q!: * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * $without $baggageAll  * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) *
        q!: * ($how/$want/$need2/$canSg1 ([ли] (я/йа)/ли [я/йа]) / (я/йа) $canSg1/$possiblePredic) * ($issueVerb/$buyInf/$orderVerbInf/$orderMoreVerbInf/$payInf/доплатит*/$bookInf/набрат*/$chooseInf/добавит*) * {($buyVerbPast/$issueVerbPast/$bookPast/$orderPast/$payPastAll/взял*) ($ticket/$airplaneTicket/$flight/~заказ/~зоказ/~поездка/~рейс)} * $without $baggageAll  *
        script:
            if ($client.orderList && $client.orderList.length == 1) {
                if ($temp.begin == undefined) {
                    $temp.begin = true;
