theme: /railwayFaq
    ...
    state: serviceFee4Corporate
        ...
        q!: * сервисн* сбор* * (юридич*/юрик*/корпоративн*) [~лицо/~клиент/$order] * $railwayTicket *
        q!: * сервисн* сбор* * $railwayTicket * (юридич*/юрик*/корпоративн*) [~лицо/~клиент/$order] *
        q!: * (юридич*/юрик*/корпоративн*) [~лицо/~клиент/$order] * сервисн* сбор* * $railwayTicket *
        q!: * (юридич*/юрик*/корпоративн*) [~лицо/~клиент/$order] * $railwayTicket * сервисн* сбор* *
        q!: * $railwayTicket * сервисн* сбор* * (юридич*/юрик*/корпоративн*) [~лицо/~клиент/$order] *
        q!: * $railwayTicket * (юридич*/юрик*/корпоративн*) [~лицо/~клиент/$order] * сервисн* сбор* *
