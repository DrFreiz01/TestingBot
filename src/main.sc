...
#        $reactions.answer('К сожалению, по техническим причинам я не смогу сейчас помочь: <ul><li>Вы можете задать мне другой вопрос или обратиться в колл-центр Hoff с 10 до 22 (МСК) ежедневно <a href="https://hoff.ru/contacts/zagruzhennost-koll-tsentra/" target="_blank">по графику работы горячей линии</a></li></ul>.');
#        $reactions.inlineButtons({text: "Контакты Колл-центра", url: "https://hoff.ru/contacts/zagruzhennost-koll-tsentra/"});
#    });
...
#            {
#                "type":"text",
#                "text":"На этот вопрос у меня аналогичный ответ."
#            }
#            ];
...
#                <li>[назначить дату доставки] по заказу;</li>
#                <li>[уточнить статус обращения];</li>
#                <li>по остальным вопросам, пожалуйста, обращайтесь в колл-центр Hoff с 10 до 22 (МСК) ежедневно <a href="https://hoff.ru/contacts/zagruzhennost-koll-tsentra/" target="_blank">по графику работы горячей линии</a>; продолжая диалог, Вы даёте своё согласие на [обработку персональных данных]; для улучшения работы нашего сервиса диалог с Вами может быть сохранен.</li>
#            </ul>
...
#                    <li>[назначить дату доставки] по заказу;</li>
#                    <li>[уточнить статус обращения];</li>
#                    <li>по остальным вопросам, пожалуйста, обращайтесь в колл-центр Hoff с 10 до 22 (МСК) ежедневно <a href="https://hoff.ru/contacts/zagruzhennost-koll-tsentra/" target="_blank">по графику работы горячей линии</a>.</li>
#                </ul>
#                Какой у Вас вопрос?
        ...
        state: списокВопросов
            q!: ((вопросы о программе лояльности Hoff)/(вопросы по программе лояльности Hoff))
            go!: /003/ЛКБ/ЛКБ-00-00
...
#        a:  Обратитесь, пожалуйста, в колл-центр Hoff с 10 до 22 (МСК) ежедневно <a href="https://hoff.ru/contacts/zagruzhennost-koll-tsentra/" target="_blank">по графику работы горячей линии</a>.
#            <ul>
...
#            </ul>
#        inlineButtons:
#            {text: "Контакты колл-центра", url: "https://hoff.ru/contacts/zagruzhennost-koll-tsentra/"}
            ...
            state: NoOperatorsOnline || noContext=true
                ...
                a:  — Нет доступных операторов —
                    <ul>
                        ...
                        <li>рекомендуем Вам выбрать время обращения в период меньшей загруженности колл-центра: <a href="https://hoff.ru/contacts/zagruzhennost-koll-tsentra/" target="_blank">подробнее</a>.</li>
                    </ul>    
...
# ---------------------- Прощание перед закрытием чата ------------------------
    ...
    state: Оценка
        ...
        a:  Всё ли Вам понравилось?
            <ul>
                <li>оцените, пожалуйста, наш диалог от 1 до 5 (где 5 — Отлично), либо нажмите на одну из кнопок ниже.</li>
            </ul>    
        inlineButtons:   
            {text:"5 ★★★★★"}
            {text:"4 ★★★★"}
