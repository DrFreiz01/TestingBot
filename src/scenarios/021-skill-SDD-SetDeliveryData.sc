...
# ----------------------------------------------------------------------------
    ...
    #                - OrderList: {{$session.OrderList}}
                if: $session.RequestInfoID === '1'
                    ...
                    a:  Ответ получен:
                        <ul>
                            <li>переданы некорректные данные.</li>
                        <ul>
                ...
                elseif: $session.RequestInfoID === '2.1'
                    ...
                    a:  Ответ получен: 
                        <ul>
                            <li>к сожалению, не найдена информация о возможности доставки по заказу с номером {{$session.sddID}}.</li>
                        </ul>
                ...
                elseif: $session.RequestInfoID === '2.2'
                    ...
                    a:  Ответ получен:
                        <ul>
                            <li>к сожалению, в заказе {{$session.sddID}} недостаточно информации для назначения доставки.</li>
                        </ul>
                        Пожалуйста, обратитесь в Единую Информационную Службу Hoff с просьбой оформить доставку.
                elseif: $session.RequestInfoID === '2.3'
                    ...
                    a:  Ответ получен:
                        ...
                        Пожалуйста, обратитесь в Единую Информационную Службу Hoff с просьбой уточнить адрес доставки в вашем заказе.
                elseif: $session.RequestInfoID === '2.4'
                    ...
                    a:  Ответ получен:
                        <ul>
                            <li>к сожалению, введенные вами данные "{{$session.sddIDPhone}}" не соответствуют последним четырем цифрам телефона покупателя, указанного в заказе {{$session.sddID}}.</li>
                        </ul>
                ...
                elseif: $session.RequestInfoID === '3'
                    ...
                    a:  Ответ получен:
                        <ul>
                            <li>к сожалению, по заказу {{$session.sddID}} нет полной оплаты.</li>
                        </ul>
                ...
                elseif: $session.RequestInfoID === '4'
                    ...
                    a:  Ответ получен:
                        <ul>
                            <li>к сожалению, по заказу {{$session.sddID}} товары ещё не поступили на склад.</li>
                        </ul>
                        Пожалуйста, обратитесь в Единую Информационную Службу Hoff с просьбой уточнить сроки поступления товаров на склад.
                elseif: $session.RequestInfoID === '5'
                    #ОШИБКА. По предоставленным данным найден заказ, но в нём присутствует заказ на сборку.
                    a:  Ответ получен:
                        <ul>
                            <li>к сожалению, в заказе {{$session.sddID}} есть услуга "Сборка мебели", поэтому назначить дату доставки самостоятельно не получится.</li>
                        </ul>
                        Пожалуйста, обратитесь в Единую Информационную Службу Hoff с просьбой назначить доставку.
                elseif: $session.RequestInfoID === '6'
                    #УСПЕШНО. Заказ готов к назначению даты доставки (вариант 1)
                    a:  Ответ получен:
                        <ul>
                            <li>заказ {{$session.sddID}} найден. Вы можете приступить к просмотру доступных дат доставки.</li>
                        </ul>
                    go!: ../SDD-03-postGood
                elseif: $session.RequestInfoID === '7'
                    ...
                    a:  Ответ получен:
                        <ul>
                            <li>по заказу {{$session.sddID}} доставка уже назначена, но вы еще можете её поменять. Когда процесс доставки будет запущен, поменять её дату уже не получится.</li>
                        </ul>
                    go!: ../SDD-03-postGood
                elseif: $session.RequestInfoID === '8'
                    ...
                    a:  Ответ получен: 
                        <ul>
                            <li>по заказу {{$session.sddID}} процесс доставки уже запущен.</li>
                        <ul>
            ...
            state: SDD-03-OrderNumCheck
                ...
                a:  Проверьте, правильность введенных данных:
                    ...
                    Если вы уверены в их корректности:
                    <ul>
                        <li>пожалуйста, обратитесь в Единую Информационную Службу Hoff с просьбой назначить услугу доставки.</li>
                    </ul>
                    Если вы нашли ошибку:
                    <ul>
                        <li>введите корректные данные или напишите в чат другой вопрос и мы перейдем к его решению.</li>
                    </ul>
                go: ../../SDD-01
            ...
            state: SDD-03-PhoneNumCheck
                ...
                a:  Проверьте правильность введенного данных:
                    ...
                    Если вы нашли ошибку:
                    <ul>
                        <li>в следующем сообщении отправьте верные данные или напишите в чат другой вопрос и мы перейдем к его расмотрению.</li>
                    </ul>
                go: ../../SDD-02
